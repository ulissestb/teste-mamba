# Preact Mamba APP Boilerplate / Starter Kit 
...
```sh
git clone --depth 1 https://github.com/stone-payments/pos-mamba-preact-demo my-app
cd my-app
```
...
> Link project with the component library
